...
::: {.about-hero}
::: {.about-photo}
<img src="Profilepic.jpg" class="about-portrait" alt="Profile photo">
:::
...
Through PyMathon, I write about mathematics through definitions, proofs, examples, and carefully structured problem solving. Computational tools are used only when they offer a useful experiment, numerical check, or visualisation.
:::
:::
...
I created PyMathon as a place for serious but accessible mathematical exposition. Here, I want to:

- use computation selectively to explore mathematical ideas;
